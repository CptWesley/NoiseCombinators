...
/// </summary>
public sealed class BicubicNoise2D : BicubicNoiseBase2D
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BicubicNoise2D"/> class.
    /// </summary>
    /// <param name="hashing">The hashing function.</param>
    public BicubicNoise2D(IHashing64 hashing)
        : base(hashing)
    {
    }
    ...
    public BicubicNoise2D(int seed)
