...
/// </summary>
public abstract class BicubicNoiseBase2D : HashBasedNoise2D
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BicubicNoiseBase2D"/> class.
    /// </summary>
    /// <param name="hashing">The hashing function.</param>
    public BicubicNoiseBase2D(IHashing64 hashing)
        : base(hashing)
    {
    }
    ...
    public BicubicNoiseBase2D(int seed)
