...
/// </summary>
public abstract class BilinearNoiseBase2D : HashBasedNoise2D
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BilinearNoiseBase2D"/> class.
    /// </summary>
    /// <param name="hashing">The hashing function.</param>
    public BilinearNoiseBase2D(IHashing64 hashing)
        : base(hashing)
    {
    }
    ...
    public BilinearNoiseBase2D(int seed)
