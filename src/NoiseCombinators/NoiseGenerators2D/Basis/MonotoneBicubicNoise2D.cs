...
/// </summary>
public sealed class MonotoneBicubicNoise2D : BicubicNoiseBase2D
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MonotoneBicubicNoise2D"/> class.
    /// </summary>
    /// <param name="hashing">The hashing function.</param>
    public MonotoneBicubicNoise2D(IHashing64 hashing)
        : base(hashing)
    {
    }
    ...
    public MonotoneBicubicNoise2D(int seed)
