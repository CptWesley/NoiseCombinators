...
/// </summary>
public sealed class ShiftedNoise2D : UnaryNoiseBase2D
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ShiftedNoise2D"/> class.
    /// </summary>
    ...
    public ShiftedNoise2D(INoise2D source, double shiftX, double shiftY)
        : base(source)
    {
        ShiftX = shiftX;
        ShiftY = shiftY;
